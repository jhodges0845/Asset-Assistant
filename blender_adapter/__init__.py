...
bl_info = {
    "name": "Asset Assistant", "author": "Asset Assistant contributors", "version": (0, 9, 0),
    "blender": (5, 2, 1), "location": "3D View > Sidebar > Asset Assistant",
    "description": "Generate, modify, rig, animate, validate, and export editable 3D assets", "category": "3D View",
}


def register():
    from . import (
        animation_adoption_ui, animation_artist_ui, animation_modify_exchange, animation_names_ui, animation_tuning_ui,
    ...
    ui.register(); imported_rig_access.register(); animation_names_ui.register(); animation_artist_ui.register()
...
def unregister():
    from . import (
        animation_adoption_ui, animation_artist_ui, animation_names_ui, animation_tuning_ui, asset_file_import_ui,
    ...
    animation_adoption_ui.unregister(); animation_tuning_ui.unregister(); animation_artist_ui.unregister()
